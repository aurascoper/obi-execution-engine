...
def _seed_pending(eng: HLEngine, *, sym: str, side: str,
                  qty: float, px: float, age_s: float = 0.0,
                  reprice_count: int = 0, is_entry: bool = True) -> None:
...
async def test_partial_fill_bookkeeping():
    ...
    eng._handle_hl_fill({
        "type": "hl_fill", "symbol": sym, "side": "buy",
        "px": 3000.0, "sz": 0.004, "cloid": cloid,
    })
    ...
    eng._handle_hl_fill({
        "type": "hl_fill", "symbol": sym, "side": "buy",
        "px": 3000.0, "sz": 0.002, "cloid": cloid,
    })
