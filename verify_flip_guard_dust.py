...
_TEST_COIN_TO_SYMBOL: dict[str, str] = {c: f"{c}/USD" for c in _TEST_SZ_DECIMALS}
_TEST_SYMBOL_TO_COIN: dict[str, str] = {v: k for k, v in _TEST_COIN_TO_SYMBOL.items()}
...
CASES = [
    ...
    dict(
        name="ETH entry, on-chain flat, mem pre-written",
        symbol="ETH/USD",
        live_szi=0.0,
        mem_szi=-0.0427,
        pending_exit=False,
    ...
    dict(
        name="ETH entry, -0.0001 dust on chain (the deadlock case)",
        symbol="ETH/USD",
        live_szi=-0.0001,
        mem_szi=-0.0427,
        pending_exit=False,
    ...
    dict(
        name="ETH entry, -0.0002 (2 lots, clearly above 1.5x cap)",
        symbol="ETH/USD",
        live_szi=-0.0002,
        mem_szi=-0.0427,
        pending_exit=False,
        expect_allowed=False,
        expect_rollback="rollback_entry",
    ),
    dict(
        name="ETH entry, -0.0010 genuine short on chain → block",
        symbol="ETH/USD",
        live_szi=-0.0010,
        mem_szi=-0.0427,
        pending_exit=False,
    ...
    dict(
        name="BTC entry, 1e-5 dust (1 lot) → allow",
        symbol="BTC/USD",
        live_szi=0.00001,
        mem_szi=-0.00134,
        pending_exit=False,
    ...
    dict(
        name="BTC entry, 2e-5 (2 lots, above 1.5x) → block",
        symbol="BTC/USD",
        live_szi=0.00002,
        mem_szi=-0.00134,
        pending_exit=False,
    ...
    dict(
        name="SOL entry, on-chain flat → allow",
        symbol="SOL/USD",
        live_szi=0.0,
        mem_szi=-0.5,
        pending_exit=False,
    ...
    dict(
        name="SOL entry, 1-lot dust 0.01 (under 1.5x cap) → allow",
        symbol="SOL/USD",
        live_szi=0.01,
        mem_szi=-0.5,
        pending_exit=False,
    ...
    dict(
        name="SOL entry, 0.02 (2 lots, above 1.5x cap) → block",
        symbol="SOL/USD",
        live_szi=0.02,
        mem_szi=-0.5,
        pending_exit=False,
    ...
    dict(
        name="SOL entry, 0.5 genuine long on chain → block",
        symbol="SOL/USD",
        live_szi=0.5,
        mem_szi=-0.5,
        pending_exit=False,
    ...
    dict(
        name="ETH exit, live matches memory (same sign)",
        symbol="ETH/USD",
        live_szi=-0.0427,
        mem_szi=-0.0427,
        pending_exit=True,
    ...
    dict(
        name="ETH exit, live dust -0.0001 → block (effectively flat)",
        symbol="ETH/USD",
        live_szi=-0.0001,
        mem_szi=-0.0427,
        pending_exit=True,
        expect_allowed=False,
        expect_rollback="rollback_exit",
    ),
    dict(
        name="ETH exit, live flat 0.0 → block",
        symbol="ETH/USD",
        live_szi=0.0,
        mem_szi=-0.0427,
        pending_exit=True,
    ...
    dict(
        name="ETH exit, live is +0.0427 (wrong side) → block",
        symbol="ETH/USD",
        live_szi=+0.0427,
        mem_szi=-0.0427,
        pending_exit=True,
    ...
    dict(
        name="SOL exit, live dust 0.01 (under cap) → block (effectively flat)",
        symbol="SOL/USD",
        live_szi=0.01,
        mem_szi=-0.5,
        pending_exit=True,
    ...
    dict(
        name="SOL exit, live matches memory -0.5 → allow",
        symbol="SOL/USD",
        live_szi=-0.5,
        mem_szi=-0.5,
        pending_exit=True,
...
def main() -> None:
    ...
    for i, case in enumerate(CASES, 1):
        ...
        print(
            f"       allowed={out['allowed']} (expect {case['expect_allowed']})  "
